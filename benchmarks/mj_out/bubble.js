...
function main(size){
    ...
    for (i = mc_t6; i<=size; i = i+1) {
        ...
        mc_t29 = y.mj_numel();
        mc_t27 = mc_t26 < 0;
        mc_t30 = mc_t26 >= mc_t29;
        mc_t31 = mc_t27 || mc_t30;
        if (mc_t31) {
...
function bubble(A){
    ...
    mc_t17 = n - mc_t18;
    mc_t25 = 1;
    for (j = mc_t25; j<=mc_t17; j = j+1) {

        mc_t19 = 1;
        mc_t16 = n - mc_t19;
        mc_t24 = 1;
        for (i = mc_t24; i<=mc_t16; i = i+1) {
            mc_t32 = i - 1;
            mc_t35 = x.mj_numel();
            mc_t33 = mc_t32 < 0;
            mc_t36 = mc_t32 >= mc_t35;
            mc_t37 = mc_t33 || mc_t36;
            if (mc_t37) {
                mc_error("index out of bounds");
            }
            mc_t12 = x[mc_t32];
            ...
            mc_t41 = x.mj_numel();
            mc_t39 = mc_t38 < 0;
            mc_t42 = mc_t38 >= mc_t41;
            mc_t43 = mc_t39 || mc_t42;
            if (mc_t43) {
                mc_error("index out of bounds");
            }
            mc_t13 = x[mc_t38];
            mc_t23 = mc_t12 > mc_t13;
            if (mc_t23) {
                mc_t44 = i - 1;
                mc_t47 = x.mj_numel();
                mc_t45 = mc_t44 < 0;
                mc_t48 = mc_t44 >= mc_t47;
                mc_t49 = mc_t45 || mc_t48;
                if (mc_t49) {
                    mc_error("index out of bounds");
                }
                temp = x[mc_t44];
                ...
                mc_t53 = x.mj_numel();
                mc_t51 = mc_t50 < 0;
                mc_t54 = mc_t50 >= mc_t53;
                mc_t55 = mc_t51 || mc_t54;
                if (mc_t55) {
                    mc_error("index out of bounds");
                }
                mc_t10 = x[mc_t50];
                ...
                mc_t60 = mc_t56 >= mc_t59;
                if (mc_t60) {
                    x = mc_resize(x, mc_t56);
                }
                x[mc_t56] = mc_t10;
                mc_t22 = 1;
                mc_t11 = i + mc_t22;
                ...
                mc_t65 = mc_t61 >= mc_t64;
                if (mc_t65) {
                    x = mc_resize(x, mc_t61);
                }
                x[mc_t61] = temp;
            }
        }
