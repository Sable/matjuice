...
function babai(R, y) {
    ...
    n = mc_length_M(y);
    mc_t25 = 1;
    z_hat = mc_zeros(n, mc_t25);
    mc_t8 = mc_array_get(y, [n]);
    mc_t9 = mc_array_get(R, [n, n]);
    mc_t7 = mc_rdivide_SS(mc_t8, mc_t9);
    mc_t5 = mc_round_S(mc_t7);
    z_hat = mc_array_set(z_hat, [n], mc_t5);
    
    mc_t26 = 1;
    mc_t23 = mc_minus_SS(n, mc_t26);
    mc_t27 = 1;
    mc_t24 = mc_uminus_S(mc_t27);
    mc_t30 = 1;
    
    for (k = mc_t23; k >= mc_t30; k = k + mc_t24) {
        mc_t15 = k;
        mc_t28 = 1;
        mc_t17 = mc_plus_SS(k, mc_t28);
        mc_t18 = n;
        mc_t16 = mc_colon(mc_t17, mc_t18);
        mc_t10 = mc_array_slice_dynamic_2(R, [1, null], [mc_colon(mc_t15, mc_t15), mc_t16]);
        mc_t29 = 1;
        mc_t13 = mc_plus_SS(k, mc_t29);
        mc_t14 = n;
        mc_t12 = mc_colon(mc_t13, mc_t14);
        mc_t11 = mc_array_slice_dynamic_1(z_hat, [null, 1], [mc_t12]);
        par = mc_mtimes_MM(mc_t10, mc_t11);
        mc_t21 = mc_array_get(y, [k]);
        mc_t22 = par;
        mc_t19 = mc_minus_SS(mc_t21, mc_t22);
        mc_t20 = mc_array_get(R, [k, k]);
        ck = mc_rdivide_SS(mc_t19, mc_t20);
        mc_t6 = mc_round_S(ck);
        z_hat = mc_array_set(z_hat, [k], mc_t6);
    }
...
function drv_babai(scale) {
    ...
    for (i = mc_t4; i <= scale; i = i + 1) {
        mc_t0 = 10;
        mc_t1 = 10;
        A = mc_randn(mc_t0, mc_t1);
        mc_t2 = 10;
        mc_t3 = 1;
        y = mc_randn(mc_t2, mc_t3);
        z = babai(A, y);
    }
