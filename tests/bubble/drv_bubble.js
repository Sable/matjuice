...
function bubble(A) {
    ...
    n = mc_length_M(A);
    mc_t10 = 1;
    mc_t9 = mc_minus_SS(n, mc_t10);
    mc_t17 = 1;

    for (j = mc_t17; j <= mc_t9; j = j + 1) {
        // % comparing each number with the next and swapping
        mc_t11 = 1;
        mc_t8 = n - mc_t11;
        mc_t16 = 1;

        for (i = mc_t16; i <= mc_t8; i = i + 1) {
            mc_t4 = mc_array_get(A, [i]);
            mc_t12 = 1;
            mc_t6 = i + mc_t12;
            mc_t5 = mc_array_get(A, [mc_t6]);
            mc_t15 = mc_t4 >= mc_t5;
            if (mc_t15) {
                temp = mc_array_get(A, [i]);
                mc_t13 = 1;
                mc_t7 = i + mc_t13;
                mc_t2 = mc_array_get(A, [mc_t7]);
                A = mc_array_set(A, [i], mc_t2);
                mc_t14 = 1;
                mc_t3 = i + mc_t14;
                A = mc_array_set(A, [mc_t3], temp);
            }
        }
    }
    x = A;
